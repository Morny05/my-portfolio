...
export default function ContactSection() {
    return (
        <section id="contact" className="w-full bg-[#f5f5f5] py-20 px-4">
            <div className="max-w-2xl mx-auto">
                {/* Title */}
                <h2 className="text-4xl font-bold text-center text-[#07122B] mb-14">
                    Get in Touch
                </h2>

                {/* Card */}
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 md:p-10">
                    <h3 className="text-2xl font-bold text-[#07122B] mb-10">
                        Contact Me
                    </h3>
                    ...
                    <form className="space-y-4">
                        {/* Name */}
                        <div>
                            <label className="block text-l text-sm font-bold text-black mb-1">
                                Name
                            </label>
                            ...
                            <input
                                ...
                                className="w-full rounded-l border border-gray-300 px-3 py-2 outline-none focus:ring-2 focus:ring-[#07122B]"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-gray-300 px-4 py-4 outline-none focus:ring-2 focus:ring-[#07122B]"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full rounded-lg border border-gray-300 px-4 py-4 outline-none resize-none focus:ring-2 focus:ring-[#07122B]"
                            />
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#07122B] text-white  text-m font-medium py-4 rounded-lg hover:opacity-90 transition"
                        >
                            Send Message
                        </button>
                    </form>
