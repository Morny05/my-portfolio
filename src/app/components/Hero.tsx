...
export default function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-between px-20 pt-24"
    >
      {/* left */}
      <div className="max-w-xl">
        ...
        <p className="mt-6 text-xl text-gray-600">
          Automating infrastructure, optimizing pipelines, and building reliable systems.
        </p>

        <div className="mt-8 flex gap-4">
          <a
            href="#contact"
            className="bg-black text-white not-italic px-6 py-3 rounded-full"
          >
            Get in Touch
          </a>
          ...
          <a
            href="#projects"
            className="border not-italic px-6 py-3 rounded-full text-[#0B132B] hover:bg-[#020308] hover:text-white transition"
          >
            View Projects
          </a>
        </div>
      ...
      <div>
        <img
          src="./Image ODC.jpeg"
          alt="profile"
          className="w-[450px] h-[550px] object-cover rounded-[40%]"
        />
      </div>
